...
class Create_Ticket:
    ...
    def insert_ticket(self, date_unloading, saturated_wheel):
        try:
            ...
            data = (ticket_id, 1, 5, 1, 1, "Wheel Unloading", date_unloading, 0, saturated_wheel, 3, 0, 0, 0, 0, 0, 0)
...
scan2 = ThresholdScanner(train_results_2)

above_limit_2 = scan2.scan_threshold('Train Predictions', 4000)

scan = ThresholdScanner(train_results_3)

above_limit_3 = scan.scan_threshold('Train Predictions', 4000)

scan2 = ThresholdScanner(train_results_2)

above_limit_4 = scan2.scan_threshold('Train Predictions', 4000)
